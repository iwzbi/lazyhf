use crate::{
    ...
    //     CreateBranchPopup, CreateRemotePopup, ExternalEditorPopup, FetchPopup, FileRevlogPopup,
    //     FuzzyFindPopup, HelpPopup, InspectCommitPopup, LogSearchPopupPopup, MsgPopup, OptionsPopup,
    //     PullPopup, PushPopup, PushTagsPopup, RemoteListPopup, RenameBranchPopup, RenameRemotePopup,
    //     ResetPopup, RevisionFilesPopup, StashMsgPopup, SubmodulesListPopup, TagCommitPopup,
...
//                 self.update_remote_url_popup.open(remote_name, cur_url)?;
//             }
...
//         let res = sync::delete_remote(&self.repo.borrow(), remote_name);
//         match res {
//             Ok(()) => {
...
//             (!self.any_popup_visible() && self.files_tab.is_visible())
